class Species:
    def __init__(self, dex_no, name, sprite_path, type, health, defense, attack, speed, end_health, end_defense, end_attack, end_speed, leveling_speed, previous_evolution_name, evolution_name, evolution_level, learnable_moves):
        self.dex_no = dex_no
        self.name = name
